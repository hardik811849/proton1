...
import eclips1 from "@/app/assets/eclips1.svg";
import dot from "@/app/assets/dot.svg";
import dot1 from "@/app/assets/dot1.svg";
import proton_bubble from "@/app/assets/Proton bubble.svg";
  ...
  return (
    <>
      <Image
        ...
        width={500}
        height={500}
        className="absolute sm:top-16 md:top-0 left-10 w-[50%]  z-0"
      />
      ...
      <Image
        ...
        width={500}
        height={500}
        className="absolute -top-16 sm:left-0 md:left-32 -rotate-6 w-[80%] mix-blend-color-dodge  z-0"
      />
      <Image
        src={dot1}
        alt="dot"
        width={500}
        height={500}
        className="absolute top-96 left-10 -rotate-6 w-[80%] opacity-25 mix-blend-color-dodge z-0"
      />
      <div className=""></div>
