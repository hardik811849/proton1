...
const Benifit = () => {
  return (
    <div className="relative" id="why_proton">
      <Image
      ...
      <div className="grid base:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 w-[80%] mx-auto mt-10">
        <div className="border-2 border-[#B6BAFE] rounded-3xl border-opacity-25 bg-[#0000] base:p-6 md:p-14 ">
          <h2 className="text-[30px] font-light">Safe Onshore structure</h2>
        ...
        <div className="border-2 border-[#B6BAFE] rounded-3xl border-opacity-25 bg-white bg-opacity-10  base:p-6 md:p-14 ">
          <h2 className="text-[30px] font-light">Guaranteed yield</h2>
          <p className="font-thin text-[15px]">
            Benefit from a transparent and decentralized network
          </p>
        </div>
        <div className="border-2 border-[#B6BAFE] rounded-3xl border-opacity-25 bg-[#0000]  base:p-6 md:p-14 ">
          <h2 className="text-[30px] font-light">Any time liquidity </h2>
          <p className="font-thin text-[15px]">
            Benefit from a transparent and decentralized network
          </p>
        </div>
        <div className="border-2 border-[#B6BAFE] rounded-3xl border-opacity-25 bg-white bg-opacity-10 base:p-6 md:p-14 ">
          <h2 className="text-[30px] font-light">Use as collateral</h2>
          <p className="font-thin text-[15px]">
            Benefit from a transparent and decentralized network
          </p>
        </div>
